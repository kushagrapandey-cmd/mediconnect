...
const handleDelete = async (filename) => {
  ...
  return (
    <div className="text-gray-300 flex flex-col justify-center items-center h-screen">
      <div className="mt-72">
        <div className="p-5">
          ...
          <p className="text-center text-xl p-5 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 hover:bg-gradient-to-l">
            {" "}
            Manage your whole Medical History at one place with assured
            privacy!!{" "}
          </p>
        </div>
        <div>
